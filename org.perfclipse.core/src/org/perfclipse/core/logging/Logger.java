...
package org.perfclipse.core.logging;
...
/**
 * Logger class which wraps Eclipse ILog instance and
 * defines simple api for logging using Eclipse.
 * @author Jakub Knetl
 *
 */
public class Logger {
	 ...
	 * @param pluginId
	 */
	public Logger(ILog logger, String pluginId) {
		super();
		this.logger = logger;
