 ...
 *
 */
public class DeleteValidatorCommand extends Command {

	private ValidationModel validation;
	private ValidatorModel validator;
	private int index;

	public DeleteValidatorCommand(ValidationModel validation,
	...
	@Override
	public void execute() {
		index = validation.getValidation().getValidator().indexOf(validator.getValidator());
