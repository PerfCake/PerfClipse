 ...
 *
 */
public class DeleteReporterCommand extends Command {

	private ReportingModel reporting;
	private ReporterModel reporter;
	private int index;

	public DeleteReporterCommand(ReportingModel reporting,
			ReporterModel reporter) {
		super("Delete reporter");
	...
	@Override
	public void execute() {
		index = reporting.getReporting().getReporter().indexOf(reporter.getReporter());
